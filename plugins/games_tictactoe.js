...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} You are the winner 🎉 *+${winScore} XP*` : isTie ? `The game is over with a tie *+${playScore} XP*` : `Now it's your turn ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`}
